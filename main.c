...
unsigned char send_data_structure[] = {
	0x41, // TCON HI byte
	0x8E, // TCON LO byte
//	0x8F, // TCON LO byte TSET用B-Wを接続
	0x03, // VOLATILE Wiper 0 HI byte
	0x00, // VOLATILE Wiper 0 LO byte registance 100k Ω
	0x03, // VOLATILE Wiper 0 HI byte
	0xFF, // VOLATILE Wiper 0 LO byte registance 30 Ω
//	0x40, // VOLATILE Wiper 0 LO byte registance 30 Ω
};
